    ...
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/homer/js").Include(
                      ...
                      //"~/Scripts/loadpartialview.js",
                      "~/Vendor/peity/jquery.peity.min.js",
                      "~/Vendor/sparkline/index.js",
                      "~/Scripts/homer.js",
                      "~/Scripts/charts.js"));
            // Homer script
            bundles.Add(new ScriptBundle("~/bundles/effect/js").Include(
            ...
            //Json.js
            bundles.Add(new ScriptBundle("~/bundles/json/js").Include(
                      "~/Scripts/Json.js"));

            //Config.js
            bundles.Add(new ScriptBundle("~/bundles/config/js").Include(
                      "~/Scripts/MedicoConfig.js"));

            //Scrolling - nav
            bundles.Add(new StyleBundle("~/bundles/scrolling-nav/css").Include(
                     "~/Content/scrolling-nav.css"));

            bundles.Add(new ScriptBundle("~/bundles/scrolling-nav/js").Include(
                      "~/Scripts/jquery.easing.min.js",
                      "~/Scripts/scrolling-nav.js"));

            //Typehead (Autocomplete TextBox)
            ...
            // placeholders A placeholder value can be defined and will be 
            // displayed until a selection is made. 
            // Select2 uses the placeholder attribute on multiple select boxes, 
            // which requires IE 10+. 
            // We support it in older versions with the Placeholders.js polyfill.
            bundles.Add(new ScriptBundle("~/bundles/placeholders/js").Include(
