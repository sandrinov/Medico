...
namespace IdentityServer3.Host.Config
{
    static class Users
    {
        public static List<InMemoryUser> Get()
        {
            ...
            {
                new InMemoryUser{Subject = "818727", Username = "fabio", Password = "fabio",
                    Claims = new Claim[]
                    {
                        new Claim(Constants.ClaimTypes.Name, "Fabio De Gioia"),
                        new Claim(Constants.ClaimTypes.GivenName, "Fabio"),
                        new Claim(Constants.ClaimTypes.FamilyName, "De Gioia"),
                        new Claim(Constants.ClaimTypes.Email, "fabio.degioia@gmail.com"),
                        new Claim(Constants.ClaimTypes.EmailVerified, "true", ClaimValueTypes.Boolean),
                        new Claim(Constants.ClaimTypes.Role, "Admin"),
                        new Claim(Constants.ClaimTypes.Role, "Geek"),
                        new Claim(Constants.ClaimTypes.WebSite, "http://www.fabiodegioia.com"),
